...
// 	type mockBehaviorUpBalance func(r *mock_service.MockUpBalance, id int64, amount float32)
...
// 			inputSecondUser: 2,
// 			inputAmount:     743.63,
// 			mockBehaviorUpBalance: func(r *mock_service.MockUpBalance, id int64, amount float32) {
// 				var err error = nil
